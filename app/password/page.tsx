...
export default function Profile() {
  ...
  const handleSubmitPassword = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.put(
        `https://golangapi-j5iu.onrender.com/api/v2.0/member/mobile/profile/auth/2`,
        password,
  ...
  const handleSubmitPin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.put(
        `https://golangapi-j5iu.onrender.com/api/v2.0/member/mobile/profile/auth/1`,
        pin,
        { headers: { "Content-Type": "multipart/form-data" } }
      );
    ...
    <div className="flex flex-col mt-10">
      <div className="flex flex-col px-8">
        ...
        <div className="mt-6">
          ...
          {errorMessagePassword && <ErrorMessage message={"Password Salah"} />}
